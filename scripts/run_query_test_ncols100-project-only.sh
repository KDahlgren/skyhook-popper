...
# SELECT * FROM ncols100  100% selectivity
#~ params="--project-cols \"att0\"";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA}";
#~ run_query ${cmdbase}

#~ # SELECT att0<102 FROM ncols100 1%
#~ params="--select \"att0,lt,102\" --project-cols \"att0\" ";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA}";
#~ run_query ${cmdbase}
...
#~ # SELECT att0<102 FROM ncols100 1%
#~ params="--select \"att0,lt,102\" --project-cols \"*\" ";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA}";
#~ run_query ${cmdbase}
...
#~ # SELECT att0<1004 FROM ncols100 10%
#~ params="--select \"att0,lt,1004\"";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA}";
#~ run_query ${cmdbase}
...
#~ # SELECT att0<10001 FROM lineitem 100%
#~ params="--select \"att0,lt,10001\"";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA}";
#~ run_query ${cmdbase}

#~ # SELECT att0<10001 FROM ncols100 100%
#~ params="--select \"att0,lt,10001\"";
#~ cmdbase="${SKYHOOKBUILD}/bin/run-query  ${params} --data-schema ${DATA_SCHEMA} --use-cls";
#~ run_query ${cmdbase}
